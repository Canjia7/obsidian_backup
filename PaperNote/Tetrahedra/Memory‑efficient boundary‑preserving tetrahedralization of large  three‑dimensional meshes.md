...
# 5 Experiments
## 5.1 Mesh quality
我们使用slim energy作为质量指标，如[[Tetrahedra/Tetrahedral Meshing in the Wild]]中
...
其次，我们只将框架用于tetgen，然而它可以和其它网格工具（如tetwild [[Tetrahedra/Tetrahedral Meshing in the Wild]]），由于tetwild也可能出现out-of-memory，因此它会受益于本文方法